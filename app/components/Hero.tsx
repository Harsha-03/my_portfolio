  ...
  return (
    ...
    >
      <span
        ...
        style={{
          background: hovered ? social.hoverBg : "rgb(24,24,27)",
        }}
      />
  ...
  return (
    <section id="home" className="section relative">
      <div className="container relative">
        ...
        <motion.div
          className="pt-20 md:pt-24 max-w-4xl"
          variants={container}
          initial="hidden"
          animate="show"
        >
          ...
          >
            ...
            <span className="block mt-1">I design clear, usable,</span>
          ...
          >
            UI/UX designer with a frontend foundation &mdash; focused on
            clarity, usability, and interaction systems that translate directly
            into shipped, production-ready products.
          </motion.p>

          <motion.div
            variants={item}
            className="mt-4 flex flex-wrap items-center gap-1.5 md:gap-2 text-xs md:text-sm"
          >
          ...
          <motion.div
            variants={item}
            className="mt-6 md:mt-8 flex items-center gap-3 md:gap-4 flex-wrap"
          >
            <motion.a
              href="#projects"
          ...
          <motion.div
            variants={item}
            className="mt-10 md:mt-12 flex flex-col items-center gap-2 text-zinc-500"
          >
