...
export default function SplashGate() {
  ...
  useEffect(() => {
    /* Force scroll to top BEFORE we render anything underneath */
  ...
  /* Also force scroll-to-top right when splash fades */
  useEffect(() => {
      ...
      {visible && (
        ...
        >
          ...
          <div className="relative flex items-end gap-1">
            {LETTERS.map((letter, i) => (
              <motion.span
                ...
                animate="show"
                exit="exit"
                className="text-[clamp(3.5rem,10vw,5.5rem)] font-extrabold leading-none tracking-tighter text-white select-none"
          ...
          <motion.div
            ...
            className="mt-4 h-px w-20 bg-gradient-to-r from-transparent via-blue-400/60 to-transparent origin-left"
          />
