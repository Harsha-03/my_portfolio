...
He is comfortable in IC roles and in roles with light design leadership scope.
He is not currently looking for pure design management roles without hands-on
ship responsibility.
...
**Right now** Harsha is the sole design owner on Phoenix AI at Community
Dreams Foundation. Phoenix AI is a live AI-powered health optimization
platform (biomarker data, wearable device signals, ML-driven health scores,
supplement recommendations, longevity insights). Live at phoenix-cdreams.org.

Two weeks in, he has shipped a full dashboard redesign, brand cohesion
overhaul, and cross-platform navigation consolidation with direct ship
authority to production. Six documented design reframes.

He is also publishing interaction craft writing in Design Bootcamp on Medium.

---

## Seniority Level

Harsha has 2.5 years of shipped production experience across four roles:

- Sole design owner on a live AI product with ship authority (Phoenix AI, 2026)
- Founding designer at a client-facing studio, 10+ products shipped in 4
  verticals (BuiltinTech, 2023)
- UI Designer & Frontend Developer at a production Agile team (Areksoft, 2022)
- First end-to-end production project still live 4+ years later (NRI
  Wellbeing, 2022)

This is a mid-level IC designer profile with senior signals in specific
dimensions:

- Ship authority and defended decisions (Phoenix AI)
- Systems-level thinking (BuiltinTech intake-to-ship pattern)
- Longevity of decisions (NRI Wellbeing IA held for 4+ years)
- Named motion vocabulary (Phoenix AI)
- Diagnostic case study format (all published case studies)

He is not senior in years of experience. He is senior in specific practice
areas that recur across his work.
...
- **Work authorization:** OPT authorized in the US
...
- Figma (primary)
- FigJam (research, workshops, case studies)
...
- Framer Motion
- shadcn/ui
- Supabase (auth, real-time data, storage)
- Vercel (deployment)
...
- OpenAI API
- RAG systems (the portfolio itself uses a custom RAG chatbot trained on 8
  knowledge files)
- Prompt design
- AI-powered interaction patterns and responsible-AI guardrails

**Process:**

- End-to-end design
- Cross-functional collaboration (Engineering, PM, Research, Content)
...
Harsha's design process depends on the problem class, but a recurring pattern
across his shipped work:

1. **Diagnose the actual problem.** The ticket is a symptom. Sit with the
   product, identify what's actually broken.
2. **Reject the obvious fix if it's the wrong one.** Every case study includes
   at least one rejected alternative. GPS pickup, queue counter, and barista
   cam were all rejected before landing on the four-state model for the
   Missing State case study. Full-row status washes were rejected before
   landing on the 3px left border pattern at Phoenix AI.
...
Harsha publishes interaction craft writing in **Design Bootcamp** on Medium.
...
Being direct about scope is a senior signal. Harsha is:

- **Not** a design manager with prior team leadership at scale
- **Not** a specialist in a single vertical (his experience spans healthcare,
  fulfillment, alumni platforms, service marketplaces, and AI products)
...
Case study order (top to bottom):
...
7. Portfolio (meta case study)
8. LifeOS (concept work)
